 ...
 **/
    ...
    if($_REQUEST['button']=="Add") //---------------------------------------------------------------------------------------------------------------------------------ADD BUTTON
    {
      ...
      else
      {
        ...
        $query = "INSERT INTO student(Roll_no,Fname,Mname,Lname,Dateofjoin,Education_year,program,image) VALUES ('$roll','$fname','$mname','$lname','$doj','$ay',$prog,'$imagetmp');";
    ...
    <head>
      ...
      <link rel="stylesheet" href="Studentia-upgrade.css">
        ...
        <div class="container landing">
          <div class="row landingrow">
            <div class="col-md-3" id="function-left-section"><!-- LEFT PARTITION----------------------------------------------------------------------------------------------------------->
              ...
              <form id="studentfilter" name="sfilter" action="student-incharge.php" method="POST" onsubmit="return val()">
             <div class="row">
                  ...
                  <div class="popup" id="popup-addst">
                    ...
                    <div class="stcontent">
                      ...
                      <div id="st-addform"><form id="addcourse-admin" name="addst" action="student-incharge.php" method="POST" onSubmit="return validateAddStudent()">
                        ...
                        <div class="row mb-3"><div class="col-6">Photograpgh</div><div class="col-6"><input class="roundedinput" type="file" name="image" id="addimg"></div></div>
